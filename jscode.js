...
function checkdcbox() {
    ...
    var ast;
    var valu = document.getElementById("cboxchk");
    ...
    if (valu.checked == true) {
        for (var k = 1; k < 16; k++) {
            ...
            document.getElementById(ast).checked = true;
            //document.getElementById(ast).innerHTML=valu;
        }
    }
    else {
...
function checkdsub() {
    var ast;
    var valu = document.getElementById("subtyp1").value;
    for (var k = 2; k < 16; k++) {
...
function langchange(x) {
    ...
    else if (ds.match(/Chinese Cantonese/)) document.getElementById(l).selectedIndex = 4;
    else if (ds.match(/Chinese Simplified/)) document.getElementById(l).selectedIndex = 5;
    else if (ds.match(/Chinese Traditional/)) document.getElementById(l).selectedIndex = 6;
    else if (ds.match(/Croatian/)) document.getElementById(l).selectedIndex = 7;
    else if (ds.match(/Czech/)) document.getElementById(l).selectedIndex = 8;
    else if (ds.match(/Danish/)) document.getElementById(l).selectedIndex = 9;
    else if (ds.match(/Dutch/)) document.getElementById(l).selectedIndex = 10;
    else if (ds.match(/Finnish/)) document.getElementById(l).selectedIndex = 13;
    else if (ds.match(/French \[Parisian\/Euro\]/)) document.getElementById(l).selectedIndex = 14;
    else if (ds.match(/French \[Canadian\/Quebecois\]/)) document.getElementById(l).selectedIndex = 15;
    else if (ds.match(/German/)) document.getElementById(l).selectedIndex = 16;
    else if (ds.match(/Greek/)) document.getElementById(l).selectedIndex = 17;
    else if (ds.match(/Hebrew/)) document.getElementById(l).selectedIndex = 18;
    else if (ds.match(/Hindi/)) document.getElementById(l).selectedIndex = 19;
    else if (ds.match(/Hungarian/)) document.getElementById(l).selectedIndex = 20;
    else if (ds.match(/Indonesian/)) document.getElementById(l).selectedIndex = 21;
    else if (ds.match(/Italian/)) document.getElementById(l).selectedIndex = 22;
    else if (ds.match(/Korean/)) document.getElementById(l).selectedIndex = 24;
    else if (ds.match(/Latvian/)) document.getElementById(l).selectedIndex = 25;
    else if (ds.match(/Malay/)) document.getElementById(l).selectedIndex = 26;
    else if (ds.match(/Norwegian/)) document.getElementById(l).selectedIndex = 27;
    else if (ds.match(/Norwegian Nynorsk/)) document.getElementById(l).selectedIndex = 28;
    else if (ds.match(/Norwegian Bokmal/)) document.getElementById(l).selectedIndex = 29;
    else if (ds.match(/Polish/)) document.getElementById(l).selectedIndex = 30;
    else if (ds.match(/Portuguese Brazilian|Portuguese \(BRZ\)/)) document.getElementById(l).selectedIndex = 31;
    else if (ds.match(/Portuguese European/)) document.getElementById(l).selectedIndex = 32;
    else if (ds.match(/Romanian/)) document.getElementById(l).selectedIndex = 33;
    else if (ds.match(/Russian/)) document.getElementById(l).selectedIndex = 34;
    else if (ds.match(/Serbian/)) document.getElementById(l).selectedIndex = 35;
    else if (ds.match(/Slovak/)) document.getElementById(l).selectedIndex = 36;
    else if (ds.match(/Spanish CST|Spanish Castilian|\(CST\)/)) document.getElementById(l).selectedIndex = 37;
    else if (ds.match(/Latin Spanish|Spanish \(LAS\)|LAS/)) document.getElementById(l).selectedIndex = 38;
    else if (ds.match(/Swedish/)) document.getElementById(l).selectedIndex = 39;
    else if (ds.match(/Tagalog/)) document.getElementById(l).selectedIndex = 40;
    else if (ds.match(/Thai/)) document.getElementById(l).selectedIndex = 41;
    else if (ds.match(/Turkish/)) document.getElementById(l).selectedIndex = 42;
    else if (ds.match(/Ukrainian/)) document.getElementById(l).selectedIndex = 43;
    else if (ds.match(/Vietnamese/)) document.getElementById(l).selectedIndex = 44;
    else if (ds.match(/English/)) document.getElementById(l).selectedIndex = 11;
    else if (ds.match(/English \(UK\)/)) document.getElementById(l).selectedIndex = 12;
    else if (ds.match(/Japanese/)) document.getElementById(l).selectedIndex = 23;
...
function myFunction(x) {
    ...
    var stype = document.getElementById(st).value;

    if (stype == '' || lang == '' || frt == '' || ptype == '') {
    ...
    if (dec == 0) {
        ...
        if ((document.getElementById(pc).checked) && (ptype == "_Primary")) {

            ptype = "";
            //alert(dashspl[2]);
            for (var x = 0; x < dashspl.length; x++)
                if (dashspl[x].match(/NetflixFinalProxy/)) {

                    if (dashspl[2].length < 1 && dashspl[2].match(/[\^d]/)) {
                        pid = dashspl[39];


                    }
                    if (pid.length < 2) {
                        var proxyfull = dashspl[x].split('_');
                    ...
                    if (pid == "") {
                        var proxyfull = dashspl[20].split('_');
                        pid = proxyfull[1];

                    }
                    if (typeof pid == 'undefined')
                        alert("Package ID not detected, enter manually.");

                    else
                        if (pid.match(/[A-Za-z]+/))
                            alert("Please check package ID.");
                        //		alert(pid);	
            ...
            if (mo == "")
                alert("Package ID not detected");

        }
        else if ((!document.getElementById(pc).checked) && (ptype == "_Primary")) {
            mo = mo;
            ptype = "";
        }
            ...
            if (seasonnumber !== "") {
                ...
                if (epname != "" || shownamefull[1].length < 1) {
                    ...
                    if (seasonnumber == 0 || seasonnumber == null) {
                        alert("Season number not detected. Default season number set to 1.");
                        seasonnumber = 1;

                    }
                    if (z.match(/F[0-9]/)) {
                        ep1 = z.replace(/\[|\]/g, '');
                        var fnam = mo + "_" + lang + "_" + showname + "_" + "S" + seasonnumber + "_" + ep1 + "_" + epname + "_" + frt + ptype;
                    }

                    else
                        var fnam = mo + "_" + lang + "_" + showname + "_" + "S" + seasonnumber + "_" + "E" + ep1 + "_" + epname + "_" + frt + ptype;
                    ...
                    var fnam = mo + "_" + lang + "_" + showname + "_" + "S" + seasonnumber + "_" + "E" + ep1 + "_" + frt + ptype;
                    fnam = fnam.replace(/( |"|“|”|\?|!|,|')/g, '');
                    fnam = fnam.replace(/\[/g, '_[');
                    fnam = fnam.replace(/\]/g, ']_');
                ...
                if (seasonnumber !== 5789635 & (epname !== "" | epname.length !== 0)) {
                    var fnam = mo + "_" + lang + "_" + showname + "_S0" + seasonnumber + "_" + "E" + ep1 + "_" + epname + "_" + frt + ptype;
                }
                else if (seasonnumber == 5789635) {
                    var fnam = mo + "_" + lang + "_" + eptitle + "_" + frt + ptype;
                }
                else {
                    var fnam = mo + "_" + lang + "_" + showname + "_" + "S0" + seasonnumber + "_" + "E" + ep1 + "_" + frt + ptype;
                }
                fnam = fnam.replace(/( |"|“|”|\?|!|,|')/g, '');
                fnam = fnam.replace(/\[/g, '_[');
                fnam = fnam.replace(/\]/g, ']_');
        ...
        //if [] NOT present in dash name
            ...
            if (epnam != eptitle) {
                if (epnam[1] !== "" || epnam[1] !== null) {
                    ...
                    if (epnam[1].length > 0) {
                        ...
                        if (epnam[1] !== "Episode" || epnam[1] !== "EPISODE")
                            var fnam = mo + "_" + lang + "_" + epnam[0] + "]_" + epnam[1] + "_" + frt + ptype;
                    }
                    else {
                ...
                var fnam = mo + "_" + lang + "_" + epname + "_" + frt + ptype;
                fnam = fnam.replace(/( |"|“|”|\?|!|,|')/g, '');
                fnam = fnam.replace(/\[/g, '_[');
                fnam = fnam.replace(/\]/g, ']_');
                //temp fix for season and episode				
    ...
    if (dec == 1) {
        ...
        if (mo == "" || mt == "" || frt == "" || ptype == "" || lang == "")
            alert("Enter all values");


        if ((document.getElementById(p).checked) && ptype == "_Primary")
            alert("Please enter package ID manually.");
        if (ptype == "_Primary") {
            ptype = "";
        }

        var final = mo + us + lang + us + mt + us + ename + season + ep1 + frt + ptype;
